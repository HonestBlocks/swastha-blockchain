...
import { deleteShipmentComponent } from './deleteShipment.component';
...
describe('deleteShipmentComponent', () => {
  ...
  let mockdeleteShipmentService;
  let mockDataService

  beforeEach(async(() => {

    mockdeleteShipmentService = sinon.createStubInstance(deleteShipmentService);
    mockdeleteShipmentService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: deleteShipmentService, useValue: mockdeleteShipmentService },
