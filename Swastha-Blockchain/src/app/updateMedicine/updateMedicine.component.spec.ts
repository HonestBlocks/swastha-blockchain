...
describe('updateMedicineComponent', () => {
  ...
  let mockupdateMedicineService;
  let mockDataService

  beforeEach(async(() => {

    mockupdateMedicineService = sinon.createStubInstance(updateMedicineService);
    mockupdateMedicineService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: updateMedicineService, useValue: mockupdateMedicineService },
