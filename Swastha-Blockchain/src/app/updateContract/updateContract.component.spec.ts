...
describe('updateContractComponent', () => {
  ...
  let mockupdateContractService;
  let mockDataService

  beforeEach(async(() => {

    mockupdateContractService = sinon.createStubInstance(updateContractService);
    mockupdateContractService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: updateContractService, useValue: mockupdateContractService },
