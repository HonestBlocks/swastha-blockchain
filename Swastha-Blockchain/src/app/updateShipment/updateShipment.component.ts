...
export class updateShipmentComponent implements OnInit {
  ...
  newTrackingCode = new FormControl('', Validators.required);
  newCurrentAddress = new FormControl('', Validators.required);
  ...
  constructor(private serviceupdateShipment: updateShipmentService, fb: FormBuilder) {
    this.myForm = fb.group({
      newTrackingCode: this.newTrackingCode,
      newCurrentAddress: this.newCurrentAddress,
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.example.mynetwork.updateShipment',
      'newTrackingCode': this.newTrackingCode.value,
      'newCurrentAddress': this.newCurrentAddress.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.newTrackingCode) {
        formObject.newTrackingCode = result.newTrackingCode;
      } else {
        formObject.newTrackingCode = null;
      }

      if (result.newCurrentAddress) {
        formObject.newCurrentAddress = result.newCurrentAddress;
      } else {
        formObject.newCurrentAddress = null;
      }
