...
describe('createContractComponent', () => {
  ...
  let mockcreateContractService;
  let mockDataService

  beforeEach(async(() => {

    mockcreateContractService = sinon.createStubInstance(createContractService);
    mockcreateContractService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: createContractService, useValue: mockcreateContractService },
