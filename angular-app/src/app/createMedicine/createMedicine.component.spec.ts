...
describe('createMedicineComponent', () => {
  ...
  let mockcreateMedicineService;
  let mockDataService

  beforeEach(async(() => {

    mockcreateMedicineService = sinon.createStubInstance(createMedicineService);
    mockcreateMedicineService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: createMedicineService, useValue: mockcreateMedicineService },
