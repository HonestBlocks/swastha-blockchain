...
async function createBox(tx){
  ...
  var medicine = factory.newRelationship('org.example.mynetwork', 'medicine', tx.medicineID);
  box.medicineID = medicine;
...
async function createContract(tx){
 //creation of contract
   ...
   console.log(tx.medicineID[0].owner.getIdentifier())
